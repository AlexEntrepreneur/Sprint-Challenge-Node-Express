...
* We learned about implementing Express routers & Express Middleware

- [x] Describe Middleware?
* Middleware is software that provides additional functionality to applications beyond those available from the API.

- [x] Describe a Resource?
* A resource is some data that can be stored on a computer and represented as a stream of bits (e.g. a document, a row in a database, or the output of an algorithm).

- [x] What can the API return to help clients know if a request was successful?
* The API can return a status code `2**`.

- [x] How can we partition our application into sub-applications?
* We can split our endpoints into separate routes and models that perform separate logic. We can also import these to different servers within the same repository, and then ultimately bring all of our servers together in our `index.js`.
